...
public class RouteTest {
    ...
    public void addStepTest() {
        ...
        tempRoute.addStep(null, null, null, null, null, 0, 0);
        assertFalse(tempRoute.getStepList().isEmpty());
        assertNotNull(tempRoute.getStepList().get(0));
    }

    @Test
    public void emptyPrintDetailedStepsTest() {
        Route tempRoute = new Route();
        assertArrayEquals(new Route[0], tempRoute.printDetailedSteps(stationList).toArray());
    }

    @Test
    public void filledPrintDetailedStepsTest() {
        initializeData();
        Route tempRoute = (Route) RouteFinder.CalculateRoute(new LatLng(38.4016940, 27.1019545),
                                                     new LatLng(38.4600723, 27.2298547),
                                                     publicTransportList,
                                                     stationList,
                                                     lineList,
                                                     new TreeMap<>()).values().toArray()[0];
        assertFalse(tempRoute.printDetailedSteps(stationList).isEmpty());
    }

    @Test(expected = StringIndexOutOfBoundsException.class)
    public void emptyPrintAllStepsTest() {
        Route tempRoute = new Route();
        tempRoute.printAllSteps();
    }

    @Test
    public void filledPrintAllStepsTest() {
        initializeData();
        Route tempRoute = (Route) RouteFinder.CalculateRoute(new LatLng(38.4016940, 27.1019545),
                new LatLng(38.4600723, 27.2298547),
                publicTransportList,
                ...
                lineList,
                new TreeMap<>()).values().toArray()[0];
        assertNotEquals("", tempRoute.printAllSteps());
    }
